...
export const ToolCard = ({
  ...
  return (
    <div className="group border border-white p-[clamp(0.8rem,2vw,1.2rem)] h-[clamp(5rem,40vw,19.2rem)] w-[clamp(7.6rem,30vw,14.5rem)] flex flex-col rounded-[clamp(0.8rem,1vw,2rem)] justify-between relative">
      <div className="group-hover:hidden transition-opacity duration-500 ease-in-out">
        <Image
          ...
          height={48}
          alt={toolName}
          className="w-fit h-[clamp(1.5rem,5vw,3rem)]"
        />
      </div>
      ...
      <div className="hidden group-hover:flex flex-col justify-between h-full">
        <Image
          ...
          width={88}
          height={88}
          className="w-fit h-[clamp(1.2rem,10vw,5.5rem)]"
          alt={toolName}
        />
